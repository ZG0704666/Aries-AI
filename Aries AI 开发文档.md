...
| 项目 | 状态 |
|------|------|
| 当前分支 | `fix/version-voice-site-sync` |
| 对齐目标 | `main` |
| 本轮范围 | 版本号同步（App v1.5.1 / 官网 V1.5.0）、语音识别模型拷贝容错、官网下载 Atom 兜底 |
| 主要风险 | 官网 fixedApkUrl 指向已发布的 V1.5.0，而 App 已迭代到 v1.5.1；待 V1.5.1 发布后需同步更新 |
...
|------|-------------|---------|---------|------|
| **1.5.1** | 20 | 2026-07-25 | 语音识别容错、官网下载 Atom 兜底、版本同步 | 当前 |
| 1.5.0 | 19 | 2026-07 | 安全加固与 razor 清理合并 | 稳定 |
| 1.4.3 | 18 | 2026-04-09 | Stream WebView深度重构、UX Program | 稳定 |
